...
srr_list=($(awk -F',' 'NR>1 {print $1}' /gpfs/work/bio/haozhewang17/data/VeloRM_data/RNA-Seq_A-to-I/SRR/SraRunTable.csv))
...
# Base directories
input_base="/gpfs/work/bio/haozhewang17/data/VeloRM_data/RNA-Seq_A-to-I/SRR"
output_base="/gpfs/work/bio/haozhewang17/data/VeloRM_data/RNA-Seq_A-to-I/SRR"
...
### STAR build index
(nohup STAR --runThreadN 10 --runMode genomeGenerate --genomeDir /gpfs/work/bio/haozhewang17/data/VeloRM_data/hg38/star_indx/ --genomeFastaFiles /gpfs/work/bio/haozhewang17/data/VeloRM_data/hg38/Homo_sapiens.GRCh38.dna.primary_assembly.fa --sjdbGTFfile /gpfs/work/bio/haozhewang17/data/VeloRM_data/hg38/Homo_sapiens.GRCh38.109.gtf --sjdbOverhang 150 > /gpfs/work/bio/haozhewang17/data/VeloRM_data/hg38/star_indx/build_index.out)&   
...
sra_table <- read.csv("/gpfs/work/bio/haozhewang17/data/VeloRM_data/RNA-Seq_A-to-I/SRR/SraRunTable.csv", 
                      header = TRUE, 
...
for (srr in srr_info){
  ...
  data <- read.vcfR(paste0("/gpfs/work/bio/haozhewang17/data/VeloRM_data/RNA-Seq_A-to-I/SRR/",srr,"/",srr,"_calls.vcf"))
  ...
  data2 <- data2[indx,]
  if(dim(data2)[1]==0){
    saveRDS(gr,paste0("/gpfs/work/bio/haozhewang17/data/VeloRM_data/RNA-Seq_A-to-I/SRR/",srr,"/",srr,"SNP.rds"))
    saveRDS(gr,paste0("/gpfs/work/bio/haozhewang17/data/VeloRM_data/RNA-Seq_A-to-I/SRR/",srr,"/",srr,"SNP_filtered.rds"))
  } else{
    ...
    read.vcfR(paste0("/gpfs/work/bio/haozhewang17/data/VeloRM_data/RNA-Seq_A-to-I/SRR/",srr,"/",srr,"_calls.vcf"))
    saveRDS(gr,paste0("/gpfs/work/bio/haozhewang17/data/VeloRM_data/RNA-Seq_A-to-I/SRR/",srr,"/",srr,"SNP.rds"))  
    ...
    gr <- readRDS(paste0("/gpfs/work/bio/haozhewang17/data/VeloRM_data/RNA-Seq_A-to-I/SRR/",srr,"/",srr,"SNP.rds"))
...
for srr in "${srr_list[@]}"; do
    ...
    -b /gpfs/work/bio/haozhewang17/data/VeloRM_data/UCSC_Introns.bed\
...
for srr in "${srr_list[@]}"; do
    ...
    -b /gpfs/work/bio/haozhewang17/data/VeloRM_data/UCSC_Exons.bed\
...
for srr in "${srr_list[@]}"; do
    echo "Processing sample: $srr"
    bedtools intersect -a "${input_base}/${srr}/${srr}_above.mapQ30.bam"\
    -b /gpfs/work/bio/haozhewang17/data/VeloRM_data/intron-na.bed\
...
gr_all <- readRDS('/gpfs/work/bio/haozhewang17/data/VeloRM_data/RNA-Seq_A-to-I/SRR/SNP_all.rds')[,-c(1:5)]
...
for (srr in srr_info) {
  ...
  j <- j+1
  name <- srr
  path <- paste0("/gpfs/work/bio/haozhewang17/data/VeloRM_data/RNA-Seq_A-to-I/SRR/",srr,"/")
...
saveRDS(spliced_list, "/gpfs/work/bio/haozhewang17/data/VeloRM_data/RNA-Seq_A-to-I/SRR/spliced_A_to_I.rds")
...
saveRDS(pre_list, "/gpfs/work/bio/haozhewang17/data/VeloRM_data/RNA-Seq_A-to-I/SRR/pre_A_to_I.rds")
...
saveRDS(isoform_list, "/gpfs/work/bio/haozhewang17/data/VeloRM_data/RNA-Seq_A-to-I/SRR/isoform_A_to_I.rds")
...
snp <- readRDS("D:/data/VeloRM_data/RNA-Seq_A-to-I/pre_process/SNP_1159.rds")
...
gtf_file <- "D:/data/VeloRM_data/RNA-Seq_A-to-I/origin/gencode.v47.chr_patch_hapl_scaff.annotation.gtf"
...
SNP_1159 <- readRDS("D:/data/VeloRM_data/RNA-Seq_A-to-I/pre_process/SNP_1159.rds")
...
# saveRDS(res, "D:/data/VeloRM_data/RNA-Seq_A-to-I/results/cell_cycle/res_A-to-I_velocity.rds")
...
#### load the embedding
```{r,warning=FALSE}
sra_table <- read.csv("D:/data/VeloRM_data/RNA-Seq_A-to-I/SRR/SraRunTable.csv", 
                      header = TRUE, 
                      stringsAsFactors = FALSE)
...
index_cell_discard <- readRDS("D:/data/VeloRM_data/RNA-Seq_A-to-I/pre_process/index_cell_discard.rds")
...
sample_info <- read.csv("D:/data/VeloRM_data/RNA-Seq_A-to-I/SRR/sample.csv", 
                      header = TRUE, 
                      stringsAsFactors = FALSE)
...
embedding_info <- read.csv("D:/data/VeloRM_data/RNA-Seq_A-to-I/SRR/Embedding.csv", 
                      header = TRUE, 
                      stringsAsFactors = FALSE)
...
# 
# saveRDS(umap_data, "D:/data/VeloRM_data/RNA-Seq_A-to-I/results/cell_cycle/umap_data_origin.rds")
