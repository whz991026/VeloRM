...
--genomeDir /gpfs/work/bio/haozhewang17/data/VeloRM_data/hg38/star_indx \
--sjdbGTFfile /gpfs/work/bio/haozhewang17/data/VeloRM_data/hg38/Homo_sapiens.GRCh38.109.gtf \
...
for srr in "${srr_list[@]}"; do
    ...
    -b /gpfs/work/bio/haozhewang17/data/VeloRM_data/hg38_bed/UCSC_Introns.bed\
...
for srr in "${srr_list[@]}"; do
    ...
    -b /gpfs/work/bio/haozhewang17/data/VeloRM_data/hg38_bed/UCSC_Exons.bed\
...
for srr in "${srr_list[@]}"; do
    echo "Processing sample: $srr"
    bedtools intersect -a "${input_base}/${srr}/${srr}_above.mapQ30.bam"\
    -b /gpfs/work/bio/haozhewang17/data/VeloRM_data/hg38_bed/intron-na.bed\
...
for srr in "${srr_list[@]}"; do
    echo "Processing sample: $srr"
    bcftools mpileup -f /gpfs/work/bio/haozhewang17/data/VeloRM_data/hg38/Homo_sapiens.GRCh38.dna.primary_assembly.fa\
    "${input_base}/${srr}/${srr}_sorted.bam" | \
...
# Read metadata
error_rate_meta_spliced <- readRDS("D:/data/VeloRM_data/DART-seq_1/pre_process/error_rate_meta_spliced_YTH.rds")
error_rate_meta_pre <- readRDS("D:/data/VeloRM_data/DART-seq_1/pre_process/error_rate_meta_pre_YTH.rds")
...
# Read counts
reads_counts_spliced_YTHmut <- readRDS("D:/data/VeloRM_data/DART-seq_1/pre_process/reads_counts_spliced_YTHmut.rds")
reads_counts_spliced_YTH <- readRDS("D:/data/VeloRM_data/DART-seq_1/pre_process/reads_counts_spliced_YTH.rds")
...
reads_counts_pre_YTHmut <- readRDS("D:/data/VeloRM_data/DART-seq_1/pre_process/reads_counts_pre_YTHmut.rds")
reads_counts_pre_YTH <- readRDS("D:/data/VeloRM_data/DART-seq_1/pre_process/reads_counts_pre_YTH.rds")
...
saveRDS(index_error,"D:/data/VeloRM_data/DART-seq_1/pre_process/index_error.rds")
saveRDS(index,"D:/data/VeloRM_data/DART-seq_1/pre_process/index.rds")


reads_counts_isoform_YTHmut <- readRDS("D:/data/VeloRM_data/DART-seq_1/pre_process/reads_counts_isoform_YTHmut.rds")
reads_counts_isoform_YTH <- readRDS("D:/data/VeloRM_data/DART-seq_1/pre_process/reads_counts_isoform_YTH.rds")
...
saveRDS(test.list,"D:/data/VeloRM_data/DART-seq_1/pre_process/test.list.rds")
saveRDS(control.list,"D:/data/VeloRM_data/DART-seq_1/pre_process/control.list.rds")
saveRDS(res_preprocess,"D:/data/VeloRM_data/DART-seq_1/pre_process/res_preprocess.rds")

SNP <- readRDS("D:/data/VeloRM_data/DART-seq_1/origin/SNP_all.rds")
SNP_index <- SNP[index]
saveRDS(SNP_index,"D:/data/VeloRM_data/DART-seq_1/pre_process/SNP.rds")
```
### DESeq2 to test the differential methylation between the spliced mRNA and pre-mRNA
```{r eval=FALSE}
# Load input data
test.list <- readRDS("D:/data/VeloRM_data/DART-seq_1/pre_process/test.list.rds")
...
# Save the results
saveRDS(result, "D:/data/VeloRM_data/DART-seq_1/pre_process/res_DESeq2.rds")
# pre deseq2
...
saveRDS(res,"D:/data/VeloRM_data/DART-seq_1/pre_process/res_binomial.rds")
...
counts_data <- read.csv("D:/data/VeloRM_data/DART-seq_1/origin/bam_read_counts.csv", 
...
DESeq2_res_spliced_overall <- readRDS("D:/data/VeloRM_data/DART-seq_1/pre_process/res_DESeq2_spliced.rds")
spliced_index <- which(DESeq2_res_spliced_overall@listData[["log2FoldChange"]]>1)

DESeq2_res_unspliced_overall <- readRDS("D:/data/VeloRM_data/DART-seq_1/pre_process/res_DESeq2_pre.rds")
...
res_DESeq2 <- readRDS("D:/data/VeloRM_data/DART-seq_1/pre_process/res_DESeq2.rds")
...
res <- readRDS("D:/data/VeloRM_data/DART-seq_1/pre_process/res_binomial.rds")
res_DESeq2 <- readRDS("D:/data/VeloRM_data/DART-seq_1/pre_process/res_DESeq2.rds")
...
volcano_plot_binomial <- ggplot(plot_data, aes(x = log2FC, y = neg_log10_p)) +
  ...
  coord_cartesian(ylim = c(0, 6),xlim = c(-4, 4))
