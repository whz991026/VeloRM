...
# Read metadata
error_rate_meta_spliced <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/error_rate_meta_spliced.rds")
error_rate_meta_pre <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/error_rate_meta_pre.rds")
index_error <- intersect(which(error_rate_meta_spliced <= 0.01), which(error_rate_meta_pre <= 0.01))



# Read counts
reads_counts_spliced<- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/reads_counts_spliced.rds")
...
reads_counts_pre<- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/reads_counts_pre.rds")
...
saveRDS(index_error,"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/index_error.rds")
saveRDS(pre_median,"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/pre_median.rds")
saveRDS(spliced_median,"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/spliced_median.rds")
saveRDS(index_median,"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/index_median.rds")
saveRDS(index,"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/index.rds")


reads_counts_isoform <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/reads_counts_isoform.rds")
reads_counts_isoform <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/reads_counts_isoform.rds")
...
saveRDS(colnames(spliced_meth_test_processed)[index_cell],"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/index_cell_name.rds")
...
saveRDS(test.list,"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/test.list.rds")
saveRDS(control.list,"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/control.list.rds")
saveRDS(res_preprocess,"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/res_preprocess.rds")
# 
SNP <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/origin/SNP_all.rds")
SNP_index <- SNP[index]
saveRDS(SNP_index,"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/SNP_1931.rds")
```
...
test.list <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/test.list.rds")
...
saveRDS(res,"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/res_binomial.rds")
...
counts_data <- read.csv("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/origin/bam_read_counts.csv", 
                       header = TRUE,  # Assumes first row contains column names
                       stringsAsFactors = FALSE)  # Prevents automatic conversion to factors

# View the first few rows
index_cell_name <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/index_cell_name.rds")
...
res_preprocess <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/res_preprocess.rds")
...
snp <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/SNP_1931.rds")
...
saveRDS(all_distances_df,"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/results/splicing_junction_analysis/all_distances_df.rds")


```
#### vis
```{r}
 all_distances_df <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/results/splicing_junction_analysis/all_distances_df.rds")
...
res_DESeq2 <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/res_DESeq2.rds")
...
res <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/res_binomial.rds")
res_DESeq2 <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/res_DESeq2.rds")
...
SNP_all <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/origin/SNP_all.rds")
SNP_1931 <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/SNP_1931.rds")
...
# the input data
test.list <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/test.list.rds")
control.list <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/pre_process/control.list.rds")
...
saveRDS(res, "D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/results/res_A_to_I_velocity.rds")
...
```{r,warning=FALSE}
# 1. Read in the data
sra_table <- read.csv("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/origin/SraRunTable.csv")
embedding <- read.csv("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/origin/embedding.csv", 
                      row.names = 1, stringsAsFactors = FALSE)
cell_to_SRR <- read.csv("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/origin/cell_to_SRR.csv", 
                        stringsAsFactors = FALSE)
...
res <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/results/res_A_to_I_velocity.rds")
# 1. Read in the data
sra_table <- read.csv("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/origin/SraRunTable.csv")
embedding <- read.csv("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/origin/embedding.csv", 
                      row.names = 1, stringsAsFactors = FALSE)
...
saveRDS(vis_umap_Beta_emb_Beta_linear_index,"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/results/vis_umap_Beta_emb_Beta_linear_index.rds")
saveRDS(vis_umap_Beta_emb_Beta_linear_index_grid,"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/results/vis_umap_Beta_emb_Beta_linear_index_grid.rds")
...
saveRDS(diffusion_density_plot_tsne,"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/results/diffusion_density_plot.rds")

arrow.scale=0.5; cell.alpha=0.4; cell.cex=1; fig.height=4;

vis_umap_Beta_emb_Beta_linear_index  <- show.velocity.on.embedding.cor(umap_results[,1:2],
             res[[3]][["current"]]$Beta[,index],
             res[[3]][["projected"]]$Beta[,index],
             res[[3]][["delta"]]$Beta[,index],
             cell.colors=cell.colors,n=50,scale='linear',
             cex=cell.cex,arrow.scale=arrow.scale,arrow.lwd=0.5,rm_uniform="mode1")
vis_umap_Beta_emb_Beta_linear_index[[1]]$layers[[1]]$aes_params$shape <- 16
vis_umap_Beta_emb_Beta_linear_index[[1]]$mapping$color <-cell.colors
...
saveRDS(vis_umap_Beta_emb_Beta_linear_index,"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/results/vis_umap_Beta_emb_Beta_linear_index_full_site.rds")
saveRDS(vis_umap_Beta_emb_Beta_linear_index_grid,"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/results/vis_umap_Beta_emb_Beta_linear_index_grid_full_site.rds")



diffusion_density_plot_tsne <- diffusion_density_plot(umap_results[,1:2],vis_umap_Beta_emb_Beta_linear_index[[2]]$tp,forward = TRUE,2500,scale="log")

saveRDS(diffusion_density_plot_tsne,"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/results/diffusion_density_plot_full_site.rds")
```
### Vis
```{r warning=FALSE}

vis_umap_Beta_emb_Beta_linear_index_full_site <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/results/vis_umap_Beta_emb_Beta_linear_index_full_site.rds")
vis_umap_Beta_emb_Beta_linear_index_grid_full_site <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/results/vis_umap_Beta_emb_Beta_linear_index_grid_full_site.rds")


diffusion_density_plot_full_site <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/results/diffusion_density_plot_full_site.rds")
...
for (i in 1:100){
  print(i)
  index_site_name_random <- sample(rownames(res[[3]][["current"]]$Beta),length(index_site_name_int_intersect))
  library(VeloRM)
  arrow.scale=0.5; cell.alpha=0.4; cell.cex=1; fig.height=4;

  vis_umap_Beta_emb_Beta_linear_index  <- show.velocity.on.embedding.cor(umap_results[,1:2],
               res[[3]][["current"]]$Beta[index_site_name_random,index],
               res[[3]][["projected"]]$Beta[index_site_name_random,index],
               res[[3]][["delta"]]$Beta[index_site_name_random,index],
               cell.colors=cell.colors,n=50,scale='linear',
               cex=cell.cex,arrow.scale=arrow.scale,arrow.lwd=0.5,rm_uniform="mode1")
  vis_umap_Beta_emb_Beta_linear_index[[1]]$layers[[1]]$aes_params$shape <- 16
  vis_umap_Beta_emb_Beta_linear_index[[1]]$mapping$color <-cell.colors
...
saveRDS(vis_umap_Beta_emb_Beta_linear_index_random_list,"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/results/vis_umap_Beta_emb_Beta_linear_index_random_list.rds")
saveRDS(vis_umap_Beta_emb_Beta_linear_index_grid_random_list,"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/results/vis_umap_Beta_emb_Beta_linear_index_grid_random_list.rds")

saveRDS(diffusion_density_plot_list,"D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/results/diffusion_density_plot.rds")
...
# ================= 1. 数据加载 =================
scRNA_seq_2_exp_latent_umap <- read.csv("D:/data/VeloRM_data/scVelo/scRNA-seq_2/results/scRNA_seq_2_exp_latent_umap.csv")

diffusion_density_plot <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/results/diffusion_density_plot.rds")

diffusion_density_plot_full_site <- readRDS("D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/results/diffusion_density_plot_full_site.rds")

# ================= 1. 数据加载 =================
meta <- scRNA_seq_2_exp_latent_umap
...
# ================= 1. 数据加载 =================
scRNA_seq_2_exp_latent_umap <- read.csv(
  "D:/data/VeloRM_data/scVelo/scRNA-seq_2/results/scRNA_seq_2_exp_latent_umap.csv"
)

diffusion_density_plot <- readRDS(
  "D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/results/diffusion_density_plot.rds"
)

diffusion_density_plot_list <- readRDS(
  "D:/data/VeloRM_data/scRNA-Seq_A-to-I_2/results/diffusion_density_plot_list.rds"
)
...
spearman_random <- sapply(diffusion_density_plot_list, function(obj){
  ...
  df_tmp2 <- data.frame(
    cell = rownames(df_tmp),
    pseudo = df_tmp$pseudo
  )

  # ⚠️ 关键：inner_join
  df_merge <- inner_join(meta, df_tmp2, by = "cell")

  # ⚠️ 再保险：去 NA
  df_merge <- df_merge %>%
    filter(!is.na(pseudo), !is.na(phase_num))
...
df_origin2 <- data.frame(
  cell = rownames(df_origin),
  pseudo = df_origin$pseudo
)

df_origin_merge <- inner_join(meta, df_origin2, by = "cell") %>%
  filter(!is.na(pseudo), !is.na(phase_num))

spearman_origin <- calc_spearman(
  df_origin_merge$pseudo,
  df_origin_merge$phase_num
)

print(paste("Baseline Spearman:", spearman_origin))

# ================= 7. 画图 =================
ggplot(res_random, aes(x = Spearman)) +
  geom_histogram(bins = 20, fill = "grey70", color = "black") +
  geom_vline(xintercept = spearman_origin, color = "red", size = 1.5) +
  theme_classic() +
  labs(
    title = "Spearman Correlation: Random vs Full Site",
